...
public class StopTimeDataSetFactory {
    public static List<DataSetEntry> createApplicationStopTimeDataSet(List<GcLoggedEvent> allGarbageCollectionEvents, long intervalInMs) {
        ...
        for (GcLoggedEvent currGcEvent : allGarbageCollectionEvents) {
            ...
            if (currGcEvent instanceof com.smeo.tools.gc.domain.ApplicationStopTimeEvent) {
                com.smeo.tools.gc.domain.ApplicationStopTimeEvent stopTimeEvent = (com.smeo.tools.gc.domain.ApplicationStopTimeEvent) currGcEvent;
            ...
            if (currGcEvent instanceof com.smeo.tools.gc.domain.ApplicationTimeEvent) {
                com.smeo.tools.gc.domain.ApplicationTimeEvent runTimeEvent = (com.smeo.tools.gc.domain.ApplicationTimeEvent) currGcEvent;
    ...
    public static List<DataSetEntry> ncreateApplicationStopTimeDataSet(List<GcLoggedEvent> allGarbageCollectionEvents, long intervalInMs) {
        ...
        for (GcLoggedEvent currGcEvent : allGarbageCollectionEvents) {
            ...
            com.smeo.tools.gc.domain.ApplicationStopTimeEvent currStopTimeEvent = null;
            com.smeo.tools.gc.domain.ApplicationTimeEvent currRuntTimeEvent = null;
            if (currGcEvent instanceof com.smeo.tools.gc.domain.ApplicationStopTimeEvent) {
                currStopTimeEvent = (com.smeo.tools.gc.domain.ApplicationStopTimeEvent) currGcEvent;
            ...
            if (currGcEvent instanceof com.smeo.tools.gc.domain.ApplicationTimeEvent) {
                currRuntTimeEvent = (com.smeo.tools.gc.domain.ApplicationTimeEvent) currGcEvent;
