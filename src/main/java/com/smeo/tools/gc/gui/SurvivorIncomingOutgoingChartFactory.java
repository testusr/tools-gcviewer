...
import com.smeo.tools.gc.dataset.SurvivorInputOutputDataSetFactory.SurvivorInputOutputDataSet;

public class SurvivorIncomingOutgoingChartFactory extends PlotChartFactory {
	public static JFreeChart createChart(SurvivorInputOutputDataSet survivorInputOutputDataSet) {
